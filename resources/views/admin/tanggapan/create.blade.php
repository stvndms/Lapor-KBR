            ...
            <div class="flex flex-col justify-center md:justify-start my-auto pt-8 md:pt-0 px-8 md:px-24 lg:px-32">
                ...
                <form class="flex flex-col pt-3 md:pt-8" action="{{ route ('beriTanggapan',$pengaduan->id_pengaduan) }}" method="post">
                    ...
                    <div class="flex flex-col pt-4">
                        ...
                        <input type="date" id="tgl_tanggapan" name="tgl_tanggapan" class="w-full appearance-none border border-gray-300 px-3 py-2 text-dark-100 placeholder-gray-500 focus:z-10 focus:border-sky-400 focus:outline-none focus:ring-sky-400 sm:text-sm">
                    </div>

                    <div class="flex flex-col pt-4">
                         <label for="about" class="block text-sm font-medium text-gray-700">Beri Tanggapan</label>
            <trix-editor class="w-full appearance-none border border-gray-300 px-3 py-2 text-dark-100 placeholder-gray-500 focus:z-10 focus:border-sky-400 focus:outline-none focus:ring-sky-400 sm:text-sm" input="x"></trix-editor>
